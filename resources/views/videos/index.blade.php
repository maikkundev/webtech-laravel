                ...
                @foreach($videos as $video)
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="card h-100 border shadow-sm" style="background-color: white; border-color: #e3e3e0;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title fw-semibold mb-2 text-truncate" style="color: #1b1b18; height: 1.5em; overflow: hidden;">
                                    {{ $video->title }}
                                </h5>
                                ...
                                <div class="small text-muted mb-3">
                                    ...
                                    <p class="mb-1">By: {{ $video->user->firstname }} {{ $video->user->lastname }}</p>
