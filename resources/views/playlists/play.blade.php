...
@section('content')
    <div class="min-vh-100" style="background-color: #FDFDFC; padding: 2rem 0;">
        <div class="container-xxl">
            ...
            <div class="mb-5">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h1 class="display-5 fw-bold" style="color: #1b1b18;">{{ $playlist->title }}</h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="card border" style="background-color: white; border-color: #e3e3e0;">
                        ...
                        <!-- Video Info -->
                        <div class="card-body">
                            <h2 id="current-video-title" class="h4 fw-bold mb-2" style="color: #1b1b18;">
                ...
                <div class="col-lg-4">
                    <div class="card border" style="background-color: white; border-color: #e3e3e0;">
                        <div class="card-header border-bottom" style="border-color: #e3e3e0;">
                            <h3 class="h5 fw-semibold mb-0" style="color: #1b1b18;">
                        ...
                        <div class="overflow-auto" style="max-height: 500px;">
                            @foreach ($playlist->videos as $index => $video)
                                <div
                                    class="video-item d-flex align-items-center p-3 border-bottom position-relative {{ $index === 0 ? 'bg-light current-video' : '' }}"
                                    ...
                                    <div class="flex-fill text-truncate">
                                        <h4 class="small fw-medium mb-1 text-truncate" style="color: #1b1b18;">
                                            {{ $video->title }}
                                        </h4>
