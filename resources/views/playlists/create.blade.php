        ...
        <div class="container" style="max-width: 600px;">
            ...
            <div class="mb-4">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h1 class="display-6 fw-bold mb-0">Create New Playlist</h1>
                </div>
                <p class="text-muted">Create a new playlist to organize your favorite videos</p>
            </div>

            <!-- Form -->
            <div class="card border p-4" style="border-color: #e3e3e0;">
                <form action="{{ route('playlists.store') }}" method="POST">
                    @csrf

                    <!-- Title -->
                    <div class="mb-4">
                        <label for="title" class="form-label small fw-medium">
                            Playlist Title *
                        </label>
                        <input type="text" id="title" name="title" value="{{ old('title') }}" maxlength="100"
                               required class="form-control py-3" style="border-color: #e3e3e0;">
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="4" class="form-control py-3"
                                  style="border-color: #e3e3e0;">{{ old('description') }}</textarea>
                        @error('description')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-5">
                        <div class="form-check">
                            ...
                            <label for="is_public" class="form-check-label small">
