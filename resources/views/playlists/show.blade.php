    ...
    <div class="container-xxl">
        ...
        <div class="mb-4">
            <div class="d-flex align-items-center mb-3">
                <a href="{{ route('playlists.index') }}" class="text-muted me-3 text-decoration-none" style="color: #706f6c !important;">
        ...
        @if($playlist->videos->count() > 0)
            <div class="card border" style="background-color: white; border-color: #e3e3e0;">
                <div class="card-header border-bottom" style="border-color: #e3e3e0;">
                    <h2 class="h5 fw-semibold mb-0" style="color: #1b1b18;">Videos ({{ $playlist->videos->count() }})</h2>
                </div>

                <div class="list-group list-group-flush">
                    @foreach($playlist->videos as $index => $video)
                        <div class="list-group-item border-0 border-bottom" style="border-color: #e3e3e0 !important;">
                            <div class="d-flex align-items-center gap-3">
                                <!-- Video Index -->
        ...
        @else
            ...
            <div class="card border text-center p-5" style="background-color: white; border-color: #e3e3e0;">
                <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 80px; height: 80px; background-color: #f8f9fa;">
                    <svg width="40" height="40" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="text-muted">
