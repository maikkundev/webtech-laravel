...
<div class="container py-4" style="max-width: 1024px;">
    <div class="card border shadow-sm" style="background-color: white; border-color: #e3e3e0;">
        ...
        <div class="card-body">
            @if($errors->any())
                <div class="alert alert-danger border d-flex align-items-start mb-4" style="background-color: #fef2f2; border-color: #fecaca;">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="text-danger me-3 mt-1 flex-shrink-0">
            ...
            <form method="POST" action="{{ route('profile.update') }}">
                ...
                <div class="border-top pt-4 mb-4" style="border-color: #e3e3e0;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            <label for="new_password_confirmation" class="form-label fw-medium" style="color: #1b1b18;">
