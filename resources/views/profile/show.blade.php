...
<div class="container-lg py-5">
    <div class="card border shadow-sm" style="background-color: white; border-color: #e3e3e0;">
        <div class="card-header border-bottom d-flex justify-content-between align-items-start" style="border-color: #e3e3e0;">
            <div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="p-3 rounded" style="background-color: #f9f9f8;">
                                <div class="h4 fw-semibold mb-1" style="color: #F53003;">{{ $user->videos->count() }}</div>
    ...
    <div class="card border shadow-sm mt-4" style="background-color: white; border-color: #e3e3e0;">
        <div class="card-header border-bottom d-flex justify-content-between align-items-center" style="border-color: #e3e3e0;">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="p-3 rounded h-100" style="background-color: #f9f9f8;">
                        <h3 class="fw-medium mb-2" style="color: #1b1b18;">
                            <a href="{{ route('playlists.show', $playlist) }}" class="text-decoration-none" style="color: #1b1b18;">
                                {{ $playlist->title }}
                            </a>
                        </h3>
    ...
    <div class="card border shadow-sm mt-4 text-center" style="background-color: white; border-color: #e3e3e0;">
        <div class="card-body py-5">
            <svg width="48" height="48" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="mx-auto text-muted mb-3">
            ...
            <div class="mt-3">
                <a href="{{ route('playlists.create') }}" class="btn text-white" style="background-color: #F53003; border-color: #F53003;">
                    Create Playlist
                </a>
            </div>
        </div>
