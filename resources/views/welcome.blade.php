...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card border shadow-sm" style="border-color: var(--border-color);">
                <div class="card-body p-4 p-lg-5">
                    <h1 class="h4 fw-medium mb-3">Let's get started</h1>
                    <p class="text-muted mb-4">Laravel has an incredibly rich ecosystem. We suggest starting with
                        the following.</p>

                    <ul class="list-unstyled mb-4">
                        <li class="d-flex align-items-center mb-3">
                            <div class="rounded-circle border border-brand me-3"
                                 style="width: 14px; height: 14px; background-color: #dbdbd7;"></div>
                            <span class="small">
                                    Read the
                                    <a href="https://laravel.com/docs" target="_blank"
                                       class="text-brand text-decoration-underline fw-medium ms-1">
                                        Documentation
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <span class="small">
                                    Join the
                                    <a href="https://laravel.com/discord" target="_blank"
                                       class="text-brand text-decoration-underline fw-medium ms-1">
                                        Discord community
                                        <svg width="10" height="11" viewBox="0 0 10 11" fill="none"
                                             class="ms-1">
                    ...
                    <div class="text-center">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="btn btn-brand me-2">
                                Get Started
                            </a>
                            @if (Route::has('register'))
