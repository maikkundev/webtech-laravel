    ...
    <div class="w-100" style="max-width: 400px;">
        <div class="text-center mb-4">
            ...
            <p class="text-muted small mt-2">
                Or
                <a href="{{ route('register') }}" class="text-decoration-none fw-medium" style="color: #F53003;">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <!-- Display Errors -->
            @if ($errors->any())
                <div class="alert alert-danger border d-flex align-items-start" style="background-color: #fff2f2; border-color: #F53003;">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #F53003;" class="me-2 mt-1 flex-shrink-0">
            ...
            @if (session('success'))
                <div class="alert alert-success border d-flex align-items-start">
                    <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="text-success me-2 mt-1 flex-shrink-0">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div>
                    <a href="#" class="text-decoration-none small fw-medium" style="color: #F53003;">
