    ...
    <div class="container-fluid px-4 py-5 fade-in">
        ...
        <div class="accordion" id="helpAccordion">
            ...
            <div class="accordion-item mb-3 card">
                ...
                <div id="gettingStartedContent" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
            ...
            <div class="accordion-item mb-3 card">
                ...
                <div id="featuresContent" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                    <div class="accordion-body">
                        <ul class="list-unstyled ms-3">
            ...
            <div class="accordion-item mb-3 card">
                ...
                <div id="faqContent" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                    <div class="accordion-body">
                        <div class="mb-4">
